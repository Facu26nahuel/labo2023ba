...
PARAM <- list()
PARAM$experimento <- "TS6410_final"

PARAM$exp_input <- "FE6310_final"
...
PARAM$train$testing <- c(202105, 202106)#incluir 202106?
...
PARAM$train$semilla <- 100195 # cambiar por su propia semilla  !!!
